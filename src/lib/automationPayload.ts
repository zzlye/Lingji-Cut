...
export function buildAutomationPayload(url: string): AutomationStartParams {
  ...
  return {
    ...
    voice_window_size: preferences.enable_voice ? preferences.voice_window_size : undefined,
    voice_window_chars: preferences.enable_voice ? preferences.voice_window_chars : undefined,
    voice_window_max_ms: preferences.enable_voice ? preferences.voice_window_max_ms : undefined,
    voice_window_gap_ms: preferences.enable_voice ? preferences.voice_window_gap_ms : undefined,
...
export function buildAutomationRerunOverrides(): AutomationRerunOverrides {
  ...
  return {
    ...
    voice_window_size: preferences.voice_window_size,
    voice_window_chars: preferences.voice_window_chars,
    voice_window_max_ms: preferences.voice_window_max_ms,
    voice_window_gap_ms: preferences.voice_window_gap_ms,
